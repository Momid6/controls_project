...
class ConvexMpcControlNode(Node):
    def __init__(self):
        super().__init__('convex_mpc_with_tracking_v2')
    ...
    def velocity_callback(self):
        ...
        self.current_state = np.array([self.current_x, self.current_y, self.current_z])
        u_mpc = convex_mpc(self.A, self.B, self.current_state, self.goal_window, self.u_min, self.u_max, self.N_mpc)
